...
// Create new postCar with image filenames from multer and update owner's postcars[]
exports.createpostCar = async (req, res) => {
  try {
    ...
    // Manually push postCar._id into VehicleOwner.postcars[]
...
exports.deletepostCar = async (req, res) => {
  ...
  try {
    ...
    // Remove reference from VehicleOwner.postcars[]
    await vehicleOwner.findByIdAndUpdate(
